...
exports.post = (url, options, uid, cb) ->
  options = @set_loudr_auth_token options, uid
...
exports.set_loudr_auth_token = (options, uid) ->
  options.headers = {} unless options.headers?
  options.headers.Authorization = @get_loudr_signed_token uid

  return options

exports.get_loudr_signed_token = (uid) ->
...
###
exports.unsigned_post = (url, options, uid, cb) ->
  options = @set_auth_token options, uid
  
  request.post @api_url + url, options, cb

exports.unsigned_get = (url, options, uid, cb) ->
  options = @set_auth_token options, uid
  
  request.get @api_url + url, options, cb

exports.unsigned_put = (url, options, uid, cb) ->
  options = @set_auth_token options, uid

  request.put @api_url + url, options, cb

exports.unsigned_del = (url, options, uid, cb) ->
  options = @set_auth_token options, uid
