(function() {
  ...
  define(["backbone", "marionette", "loudr.config", "views/projectLayout", "models/fanModel", "views/fanList", "models/noteModel", "views/note"], function(Backbone, Marionette, LoudrConfig, ProjectLayout, FanCollection, FanCollectionView, NoteModel, NewNoteView) {
    ...
    ProjectRouter = (function(_super) {
      ...
      ProjectRouter.prototype.controller = {
        ...
        newNote: function(project_id) {
          ...
          return this.layout.noteRegion.show(this.note);
        }
      };
